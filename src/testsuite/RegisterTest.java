...
public class RegisterTest extends BaseTest {
    ...
    public void userShouldRegisterAccountSuccessfully() {
        ...
        driver.findElement(By.name("firstname")).sendKeys("Ken");
        driver.findElement(By.name("lastname")).sendKeys("Williamson");
//driver.findElement(By.linkText());
        driver.findElement(By.name("email")).sendKeys("ken2023@gmail.com");
        driver.findElement(By.id("password")).sendKeys("Ken@12345");
        driver.findElement(By.id("password-confirmation")).sendKeys("Ken@12345");
