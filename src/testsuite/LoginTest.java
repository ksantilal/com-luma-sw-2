...
public class LoginTest extends BaseTest {
    ...
    public void userShouldLoginSuccessfullyWithValidCredentials(){
        ...
        driver.findElement(By.id("email")).sendKeys("ken2023@gmail.com");
        driver.findElement(By.id("pass")).sendKeys("Ken@12345");
    ...
    public void verifyTheErrorMessageWithInvalidCredentials(){
        driver.findElement(By.linkText("Sign In")).click();
        driver.findElement(By.id("email")).sendKeys("kevin2023@gmail.com");
        driver.findElement(By.id("pass")).sendKeys("Kevin@12345");
        driver.findElement(By.id("send2")).click();
    ...
    public void userShouldLogOutSuccessfully(){
        ...
        driver.findElement(By.id("email")).sendKeys("ken2023@gmail.com"); // enter email address
        driver.findElement(By.id("pass")).sendKeys("Ken@12345");
